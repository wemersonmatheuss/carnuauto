    ...
    return (
        <div ref={ref} className={`${styles.container} ${isVisible ? styles.show : styles.hide}`}>
            ...
            <div className={styles.paragraph}>
                ...
                <p>Achte dirèkteman nan  auction.</p>
                <p>San kredi, san finansman ak san biwokrasi.</p>

                <p>Isit la, ou pral aprann etap pa etap kijan pou patisipe nan vann piblik yo, chwazi pi bon 
                machin yo, epi achte yo pou yon pri anpil pi ba pase nan magazen yo — swa pou itilize 
                pèsonèl oswa pou revann epi fè pwofi.</p>

                <p><span>Ou vini nan Amerik pou viv pi byen, pa pou fè dèt.</span></p>
            </div>

            <div className={styles.button}>
                <Button name="Mwen vle economize"/>
            </div>
        </div>
    )
}